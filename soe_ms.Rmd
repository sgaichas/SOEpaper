...
*to add as authors: Donald Anderson (WHOI), Amani Bassyouni (VA Dept Health), Lisa Calvo (Rutgers), Heather Haas,  Loren Kellogg, Kristin Kleisner (TNC), Dave Kulis (WHOI), Kimberly Murray, Karl Roscher (MD DNR), Mark Terceiro*
<!--
  - name: Donald Anderson
    email: danderson@whoi.edu
    affiliation: Woods Hole Oceanographic Institution
  - name: Amani Bassyouni
    email: Amani.Bassyouni@vdh.virginia.gov
    affiliation: Virginia Department of Health
  - name: Lisa Calvo
    email: lcalvo@hsrl.rutgers.edu
    affiliation: Rutgers University Haskin Shellfish Research Laboratory
  - name: Heather Haas
    email: Heather.Haas@noaa.gov
    affiliation: NOAA NMFS Northeast Fisheries Science Center Woods Hole
  - name: Loren Kellogg
    email: Loren.Kellogg@noaa.gov
    affiliation: NOAA NMFS Northeast Fisheries Science Center Woods Hole
  - name: Kristin Kleisner
    email: kristin.kleisner.work@gmail.com
    affiliation: Environmental Defense Fund
  - name: Dave Kulis
    email: dkulis@whoi.edu
    affiliation: Woods Hole Oceanographic Institution
  - name: Kimberly Murray
    email: Kimberly.Murray@noaa.gov
    affiliation: NOAA NMFS Northeast Fisheries Science Center Woods Hole
  - name: Karl Roscher
    email: Karl.Roscher@maryland.gov
  ...
  - code: Woods Hole Oceanographic Institution
    address: 266 Woods Hole Road MS# 32, Woods Hole, MA 02543
  - code: Virginia Department of Health
    address: 109 Governor Street, Richmond, Virginia 23219
  - code: Rutgers University Haskin Shellfish Research Laboratory
    address: 6959 Miller Avenue, Port Norris, NJ  08349
  - code: Environmental Defense Fund
    address: 18 Tremont Street, Suite 850, Boston, MA 02108
  - code: Maryland Department of Natural Resources
...
Our objective was to develop streamlined, relevant ecosystem reporting tailored to a specific audience: fishery managers. Efficiency is key, because reports go to two regional management bodies annually: the New England fishery Management Council (NEFMC) and the Mid-Atlantic Fishery Management Council (MAFMC). In this paper, we outline our process and key components of our revised reporting that efficiently and transparently deliver relevant ecosystem information to both regional Councils; our lessons learned can readily apply to other ecosystem reporting efforts.
...
# Acknowledgments
We gratefully acknowledge Dr. John Boreman, chair of the MAFMC Scientific and Statistical Committee, for bluntly pointing out that initial draft ecosystem reporting lacked clear connections to management issues (and by extension, suggesting the title to this paper). Richard Seagraves, Mid-Atlantic Council staff (retired), contributed valuable insights on potential management uses of the SOE at the August 2017 workshop.  Development of ecosystem reporting in the Northeast US has been greatly facilitated and improved through the International Council for the Exploration of the Sea's Working Group on the Northwest Atlantic Regional Sea (ICES WGNARS). 
*acknowledgements: Steve Traynor (conceptual model graphics), Andy Beet (tech memo section editing), Mike Hammil (DFO gray seal consult),*
