...
author:
  - name: Sarah K. Gaichas
    ...
    affiliation: NOAA NMFS Northeast Fisheries Science Center Woods Hole
  ...
  - name: Patricia Clay
    ...
    affiliation: NOAA NMFS Northeast Fisheries Science Center Silver Spring
  - name: Lisa Colburn
    email: Lisa.Colburn@noaa.gov
    affiliation: NOAA NMFS Northeast Fisheries Science Center Narragansett
  - name: Geret DePiper
    email: Geret.DePiper@noaa.gov
    affiliation: NOAA NMFS Northeast Fisheries Science Center Woods Hole
  - name: Deb Duarte
    email: Deborah.Duarte@noaa.gov
    affiliation: NOAA NMFS Northeast Fisheries Science Center Woods Hole
  - name: Michael Fogarty
    email: Michael.Fogarty@noaa.gov
    affiliation: NOAA NMFS Northeast Fisheries Science Center Woods Hole
  - name: Kevin Friedland
  ...
  - name: Kimberly Hyde
    ...
    affiliation: NOAA NMFS Northeast Fisheries Science Center Narragansett
  - name: Chris Melrose
    email: Christopher.Melrose@noaa.gov
    affiliation: NOAA NMFS Northeast Fisheries Science Center Narragansett
  - name: Ryan Morse
    email: Ryan.Morse@noaa.gov
    affiliation: NOAA NMFS Northeast Fisheries Science Center Narragansett
  - name: Chris Orphanides
    email: Chris.Orphanides@noaa.gov
    affiliation: NOAA NMFS Northeast Fisheries Science Center Woods Hole
  - name: Charles Perretti
    email: Charles.Perretti@noaa.gov
    affiliation: NOAA NMFS Northeast Fisheries Science Center Woods Hole
  - name: Vincent Saba
    email: Vincent.Saba@noaa.gov
    affiliation: NOAA NMFS Northeast Fisheries Science Center Princeton
  - name: Laurel Smith
  ...
  - name: Scott Large
    ...
    affiliation: NOAA NMFS Northeast Fisheries Science Center Woods Hole
address:
  - code: NOAA NMFS Northeast Fisheries Science Center Woods Hole
    address: 166 Water Street, Woods Hole, MA, 02543
  - code: NOAA NMFS Northeast Fisheries Science Center Silver Spring
    address: 1315 East-West Highway, Silver Spring, MD, 20910
  - code: NOAA NMFS Northeast Fisheries Science Center Narragansett
    address: 28 Tarzwell Drive, Narragansett, RI, 02882
  - code: NOAA NMFS Northeast Fisheries Science Center Princeton
...
*add other authors from SOE acknowledgements? current list are SOE lead editors, SOE section/indicator/text contributors*
...
To achieve the goal of succinct synthesis, the report production process was changed. Due to resource limitations, initial reports (2015-2016) were developed by a single scientist from existing indicators [@program_ecosystem_2012, @nefsc_northeast_2015] with requests for updated data from multiple contributors. This process made synthesis difficult, and underutilized the knowledge and experience of contributors. A team of 3 leads worked on the 2017 report, which improved report structure, but synthesis remained difficult. Planning for the 2018 reports began in August 2017 with a workshop to develop a new report outline. Participants in the workshop included scientists (anthropologists, economists, physical and biological oceanographers, habitat specialists, food web ecologists, population biologists, protected species experts, and modelers) along with fishery managers. These diverse experts discussed the report outline as a full group but also self-organized into smaller interim working groups (human dimensions, protected species, resource species, habiat, and ecosystem productivity) to develop new indicator suites within the report sections until December 2017, when data were needed. A synthesis workshop with the full group was held in Mid-January 2018 to review subgroup results and  begin to develop synthesis within and across report sections. The full report was produced, internally reviewed, and revised during February 2018, with initial Council (Scientific and Statistical Committee, SSC) review early March 2018. Based on this initial scientific review, the report was revised again (including a section with Council/SSC comments and responses). During revision, experts were called on as necessary to respond to Council comments. 

## Priority: Efficient production for multiple management jurisdictions
To provide reports within Council management timeframes, the process described above also needed to be efficient. To achieve this, we first built on existing efforts inside and outside the region, including the previously published comprehensive Northeast US Ecosystem Status Reports (ESRs, [@program_ecosystem_2012, @nefsc_northeast_2015]), management and economimc performance reports [@clay_measuring_2014], and social indicators [@colburn_social_2012; @jepson_development_2013; @colburn_indicators_2016]; the US California Current State of the Ecosystem (SOE) report [@noauthor_annual_nodate] which served as our initial report template; and the US Alaska annual Ecosystem Considerations report [@zador_ecosystem_2016]. The experience with gathering, documenting, and visualizing indicators across all of these reports was critical to efficient development of our fishery management Council-targeted SOE report.

Other aspects of efficient reporting followed many from the California Current [@noauthor_annual_nodate], including limiting report length to fewer than 25 printed pages, using non-technical language, and including indicator data in a standardized format with standardized plotting throughout the report. In addition, we included a specific response to SSC and previous Council comments section as noted above to track progress on Council requests.

While technical descriptions and scientific references were not included in the report, both to streamline communication and to remain within the page limit, full documentation of indicators and underlying methods was provided in another document, similar to the California Current report. However, we published the technical methods separately online (see [Supporting Information S1](https://noaa-edab.github.io/tech-memo/)). This is intended to allow more streamlined version control and updating for future SOE reports. 

We produced the SOE report in Rmarkdown [@R-rmarkdown] for reproducibility and ease of conversion between the similarly structured reports with different data sources for the two regional Councils. Report source documents for the 2017 and 2018 reports were version controlled in a private github repository (due to concerns with data confidentiality). Components of these documents producing figures were reproduced, along with the details of data sources, extraction, and analysis (including example code) in the online SOE technical methods. Each indicator is described using an individual rmarkdown document, with all indicator source documents rolled up into one bookdown [@R-bookdown] and published using github pages.

Final State of the Ecosystem reports were presented to the full Councils at their April meetings in 2018. Councils received their reports as both an in person presentation along with pdf report in advance of the meeting. The main message of each presentation is whether there are big changes in the ecosystem or other threats to achieving Council management objectives. 
...
[New England State of the Ecosystem 2018](https://s3.amazonaws.com/nefmc.org/2_Ecosystem-Status-Report.pdf) reports delivered in April 2018, which are posted as part of the public record on each Fishery Management Council's website (See Supporting Information S2 and S3). We excerpt portions from each report to illustrate how the key priorities outlined above were addressed. Clear communication of relevance to management was established in the opening pages of each report, using a conceptual model and an overview of objectives linked to indicators. This executive summary also emphasized synthesis of the messages across all indicators in the report. In the main body of the report, more details are provided to support the executive summary. Relevance to managers was further emphasized by placing human dimensions objectives and indicators first in the report. We illustrate this by reproducing the first indicator and comparing presentation across the two reports. Finally, we illustrate further synthesis across individual indicators using the Mid-Atlantic report section on ecosystem productivity. Section titles below reflect priorities and the purpose of each report section.

## Priority: Clear communication of relevance to management
The executive summary outlines report purpose, structure, alignment with management objectives, and synthetic results in 2-3 pages. Here, we highlight key aspects and findings of the reports that arose from the multidiscplinary approach. We reproduce the leading pages of the Mid-Atlantic report as an example below, demonstrating the use of conceptual models, place-based spatial units, and alignment of ecosystem indicators with management objectives. Direct quotes from the reports are block indented below. Key report messages were highlighted in **boldface**. 
...
**Fig \@ref(fig:conceptual). Mid-Atlantic Ecosystem.**
...
**Fig \@ref(fig:KOBE). Summary of single species status for MAFMC stocks.** 
...
>
Many metrics aggregate species by similar functional groups.  Species that comprise the functional groups are listed below. Relative to the 2017 report, these categories have been aggregated into fewer groups for simplification and clarity (Table \@ref(tab:speciesgroupingsMAB)). 
...
## Priority: Efficient production for multiple management jurisdictions
The main body of each report follows the executive summary with more detail on the indicator results specific to each region, but using the same structure and analytical methods. The full set of report sections and includes indicators of fishery performance, human community vulnerability, fishery interactions with protected species, resource species trends, and ecosystem conditions and productivity (Table \@ref(tab:SOEcontents)). Time series plots throughout the report use the standardized approach described in the executive summary to allow quick visual identification of significant trends, and observations within the most recent 10 years. 
...
Below we give two illustrative examples of SOE reporting from the main body of the report illustrating the priorities for addressing "so what." In the first, we demonstrate how reporting of the same indicator suite was tailored for a single ecological production unit (Mid-Atlantic) and for two ecological production units within one management jurisdiction (New England). This was the first in-depth indicator discussion in each report following the executive summary. 

## Priority: Increased relevance with human dimensions objectives first
...
**Fig \@ref(fig:seafoodlandingsMAB). Mid-Atlantic seafood production indicators.** A: Mid-Atlantic Council managed seafood landings (red) and total commercial landings (black) by feeding guild. B: Mid Atlantic Council managed seafood landings (red) and total commercial landings (black) summed across guilds. C: Total recreational harvest in the Mid Atlantic.
...
**Fig \@ref(fig:seafoodlandingsGOM). New England seafood production indicators.** New England Council managed seafood landings (red) and total commercial landings (black) A: by feeding guild in the Gulf of Maine; B: by feeding guild on Georges Bank; C: summed across guilds for Gulf of Maine (top) and Georges Bank (bottom). D: Total recreational harvest in New England

During the Council meetings, there were questions regarding mechanisms for declines in seafood landings (e.g. could this be the result of management? Answer: yes). This led to conversation about the need for multiple indicators; this indicates where we are with respect to a single objective, but the full suite of indicators are needed to tease out multiple factors underlying the trends.

## Priority: Synthesis across indicators within a section
In this second example from the main body of the reports, we demonstrate synthesis across multiple indicators within a report section using the physical oceaographic and low trophic level indicators connecting to managed species in the Mid-Atlantic. The same indicators were presented using data from the Gulf of Maine and Georges Bank in the New England report, with text noting the differences and similarities between the areas (See Supporting Information, S3).
...
**Fig \@ref(fig:longtermsst). Long-term sea surface temperatures on the Northeast Continental Shelf.**  
...
**Fig \@ref(fig:SSTPPDCHLMAB). 2017 Mid-Atlantic temperature and production cycles.** SST (A), primary production (B), and Chl a (C) over 2017 (colored polygons) compared against long-term mean (black line) and +/- 1 standard deviation (grey polygon) in the Mid-Atlantic.
...
**Fig \@ref(fig:MABecoprod). Mid-Atlantic ecosystem productivity indicators.** Small-large copepod index with primary productivity anomaly (A), \\textit{C. typicus} abundance anomaly (B), groundfish condition (C), and groundfish productivity for MAFMC managed species in the Mid-Atlantic.
...
# Discussion
Rising to the "so what" challenge has improved ecosystem reporting in the Northeast US in terms of management gains, scientific contributions, and infrastructure for efficient use of limited reporting resources. Our approach was to put lessons learned from other regions and from scientific groups within our region into practice [@levin_integrated_2009, @levin_guidance_2014, @depiper_operationalizing_2017]. This resulted in more lessons learned that are broadly applicable to reporting in support of ecosystem based natural resource management. We detail each of these points in sections below, as well as work in progress for 2019 reporting building on lessons learned.

## Management gains
The changes intended to improve relevance to management clearly resonated with the Councils. In the past, Councils did not reserve space in busy agendas for ecosystem reporting. The SOE report is now being requested annually, and staff from both Councils particiated in SOE planning meetings for the 2019 report. This has resulted in an effective annual process where ecological contextual information is presented. Regular reporting within a Council process builds familiarity with the material, and can result in changes to tactical decisions when ecosystem information is combined with stock assessment information [@zador_ecosystem_2016]. 

Although the SOE report is aliged with general management objectives and of interest to the Councils, tactical management decisions in the Northeast US are still based on stock-specific analyses. While management decision criteria based on ecosystem indicator thresholds have been suggested and analyzed in general and for the Northeast US  [@murawski_definitions_2000; @link_translating_2005; @fay_testing_2013; @large_quantifying_2015; @fay_management_2015], tactical system-level management measures have rarely been implemented (but see e.g. the system level catch limit in the U.S Bering Sea [@witherell_ecosystem-based_2000]). Nevertheless, information from our SOE reports has already been used in current strategic management. 
...
Synthesis is an important and notoriously difficult scientific endeavor (example refs). While we strive for synthesis in the SOE reports, there is much further work to be done. However, because the SOE reports on scientific progress to date in many fields, connections drawn here can result in collaborative research going forward to improve our understanding. For example, the ecosystem productivity indicators shown above that elicited much discussion from the MAFMC led to a research project in progress linking zooplankton productivity to fish condition [ref? Laurel? or fill in alternates]. Management interest in these research questions is stimulated by their presentation in the SOE reports, and can help prioritize distribution of temporary resources.
...
Technical methods evaluated for ecosystem reporting also reflect an important scientific contribution. For example, indicator analysis is evolving to address time series autocorrelation in PCA [@planque_principal_2018]. In the Northeast US, simulation work done to improve our standardized trend analysis found that widely applied methods may give unreliable statistical significance for shorter indicator time series [ref Hardison et al in review simulation paper]. 

## Improved reporting infrastructure
Automation and transparency are increasingly desirable qualities for general reproducibility in science [@national_academies_of_sciences_open_2018]. These are useful not just in theory, but also for practical report production. The Rmarkdown and github workflow we used to produce the SOE was efficient and traceable and allowed effective collaboration. This framework also permitted and quick turnaround on further management requests. For example, the MAFMC risk assessment was completed within months of the Council's initial request based on the 2017 SOE as a starting point [@gaichas_implementing_2018]. Further, in June 2018, NEFMC requested a prototype ecosystem-level risk assessment as well, and production was simple: indicators for the Gulf of Maine and Georges Bank replaced those for the Mid-Atlantic Bight. This quick analysis gave New England managers a provisional example to determine whether a more in-depth analysis would be useful for them.  

After the 2018 Council reporting cycle, further improvements were made to allow access to the indicator data in the 2018 report. Web access to indicator data was implemented through the [National IEA webpage and ERDDAP](https://www.integratedecosystemassessment.noaa.gov/regions/northeast/Indicator-data) as part of a national initiative. Standard metadata for indicators are also included in the ERDDAP dataset [ref?]. The goal is to keep indicator data available and accessible for synthesis (ongoing), but also have this information widely available for modeling or other analyses.

To continue building an efficient reporting structure, the following steps are in progress for the 2019 report. A similar interdisciplinary planning workshop was held in July 2018 to further improve synthesis. Because issues with data confidentiality have been resolved, a [public github repository for the 2019 report](https://github.com/NOAA-EDAB/soe) has been set up. This repository already includes intermediate data processing [documentation](https://noaa-edab.github.io/soe/) for improved transparency and reproducibility. Plans are in place to use these framewworks for retrospective documentation of past indicators and development of new indicators. 

Efficiencies gained through improved reporting infrastructure are allowing more time scientific analysis of indicators as well. Over the coming reporting cycles, priority will be given to indicator selection and evaluation, threshold analysis, and synthetic multivariate methods such as DFA [refs]. 

Finally, continued consultation with the Councils and other management bodies on tailored integrated ecosystem reporting resulted in development of new products. Automated stock specific ecosystem reports are currently in development to be further refined for stock assessment working groups: aprotype Ecosystem Context for Stock Assessment report was provided for the 2018 summer flounder assessment [ECSA](https://noaa-edab.github.io/ECSA/). This product is more interactive and intended for a scientific audience (e.g. with error bars on figures, links to methods, and data download capability), but many of the same data and analyses are used in the SOE. The aim is to develop an ecosystem reporting data ecosystem that is transparent, accessible, and adaptable to future analyses requested by managers and scientists alike.

# Conclusion
Overall, we have found that addressing the "so what" question with respect to ecosystem reporting is an ongoing, but worthwhile challenge. Flexibility and responsiveness to audience is important, and we will continue to be willing to change our reporting as manager needs change. It is possible to retain elements of ecosystem reporting frameworks such as DPSIR and ecosystem services approaches [refs] while adjusting to regional needs. Focus on synthesis and indicators directly addressing management objectives will continue to be vital. There are no plans to concentrate only on today's management relevant subset of indicators, but rather to maintain a wide range of ecosystem indicators. Tailored reports can ghen be made selectively from a "mothership" of ecosystem data (e.g. ESR on the web) for different audiences. Overall, we have developed this straightforward process to be flexible and adjustable to needs in any region/management context. Ultimately, open science principles combined with active solicitation of manager and stakeolder needs should be an effective way forward for improving the ecosystem basis of resource management.
...
# Acknowledgments
We gratefully acknowledge Dr. John Boreman, chair of the MAFMC Scientific and Statistical Committee, for bluntly pointing out that initial draft ecosystem reporting lacked clear connections to management issues (and by extension, suggesting the title to this paper). Richard Seagraves, Mid-Atlantic Council staff (retired), contributed valuable insights on potential management uses of the SOE at the August 2017 workshop.  Development of ecosystem reporting in the Northeast US has been greatly facilitated and improved through the International Council for the Exploration of the Sea's Working Group on the Northwest Atlantic Regional Sea (ICES WGNARS). *to add- indicator data contributors: Donald Anderson, Amani Bassyouni, Lisa Calvo, Heather Haas, Mike Hammil, Loren Kellogg, Kristin Kleisner, Dave Kulis, Kimberly Murray, Karl Roscher, Mark Terceiro*
*acknowledgements: Steve Traynor (conceptual model graphics), Andy Beet (tech memo section editing)*
...
```{r map, fig.cap="Mid Atlantic Bight (MAB) spatial extent", fig.height=6, fig.width=4, out.width='\\linewidth', fig.align='center', echo = F, message = FALSE, warning = FALSE, eval = T}
...
```{r KOBE, fig.cap="Summary of single species status for MAFMC stocks", fig.height=7, fig.width=7, out.width='\\linewidth', fig.align='center', echo = F, message = FALSE, warning = FALSE, eval = T}
...
```{r seafoodlandingsGOM,  fig.cap = "New England seafood production indicators. New England Council managed seafood landings (red) and total commercial landings (black) A: by feeding guild in the Gulf of Maine; B: by feeding guild on Georges Bank; C: summed across guilds for Gulf of Maine (top) and Georges Bank (bottom). D: Total recreational harvest in New England.", echo = F, fig.height=7, fig.keep='last', fig.align='center',warning = F, message = F, out.width='\\linewidth'}
...
```{r longtermsst, fig.cap="Long-term sea surface temperatures on the Northeast Continental Shelf",  echo=F, message=FALSE, warning=FALSE , fig.height=2.5, fig.align = 'center'}
...
```{r SSTPPDCHLMAB, fig.cap="2017 Mid-Atlantic temperature and production cycles. SST (A), primary production (B), and Chl a (C) over 2017 (colored polygons) compared against long-term mean (black line) and +/- 1 standard deviation (grey polygon) in the Mid-Atlantic",echo = F, fig.show='hold', fig.align='default',warning = F, message = F,fig.height = 2.75, fig.width = 8, out.width='\\linewidth'}
## SST
...
```{r MABecoprod, fig.cap="Ecosystem productivity indicators. Small-large copepod index with primary productivity anomaly (A), \\textit{C. typicus} abundance anomaly (B), groundfish condition (C), and groundfish productivity for MAFMC managed species in the Mid-Atlantic.", echo = F, fig.keep='last', fig.align='center', warning = F, message = F, out.width='\\linewidth'}
...
PPcopes <- capture_base_plot({ 
  ...
  plot(NULL,ylim = c(-1.5,1.5), pch = 16, lwd = 3,xlim = c(1998,2017),
       cex = 1, ylab = "", las = 1, xaxt = "n", cex.axis = 0.6, xlab = "", tck=-0.01)
  ...
  with(SOE.data.2018[SOE.data.2018$Var ==  mab_prim_prod[1],], plot(Time, Value,
                                                                    ...
                                                                    yaxt = "n", pch = 16, lwd = 2, cex = 1, las = 1, xaxt = "n",xlab = ""))
  axis(side = 4, las = 1, tck=-0.01, cex.axis = 0.6)
...
<!--
```{r, MABzooplankton, fig.cap="\\textit{C. typicus} abundance anomaly (A), and small-large copepod index with primary productivity anomaly (B) in the Mid-Atlantic.",echo = F, warning = F, include = T,  fig.show='hold', fig.align='default', out.width='.49\\linewidth',warning = F, message = F}
...
```{r 'conditionfactorMAB' , fig.cap="Groundfish condition, MAB", echo = F, out.height='7cm', fig.align='center',fig.pos='H'}
knitr::include_graphics(file.path(image.dir, 'MAFMC_Fish_Condition_2018.jpg'))
```


```{r groundfishproductivity, fig.cap="Groundfish productivity (A: MAFMC managed species, B: Commercial MAB Species)", echo = F, out.width='9.2cm', out.height='9.2cm', fig.show='hold', fig.align = 'center',fig.pos='H'}
## Functions for plotting
library(ggplot2)
library(rpart)
