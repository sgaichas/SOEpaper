...
Automation and transparency are increasingly desirable qualities for general reproducibility in science []. These are useful not just in theory, but als for practical report production. The Rmarkdown and github workflow we used to produce the SOE was efficient and traceable and allowed effective collaboration. This framework also permitted and quick turnaround on further management requests. For example, the MAFMC risk assessment was completed within months of the Council's initial request based on the 2017 SOE as a starting point [@gaichas_implementing_2018]. Further, in June 2018, NEFMC requested a prototype ecosystem-level risk assessment as well, and production was simple: indicators for the Gulf of Maine and Georges Bank replaced those for the Mid-Atlantic Bight. This quick analysis gave New England managers a provisional example to determine whether a more in-depth analysis would be useful for them.  


Next steps (in progress for the 2019 report):
Similar interdisciplinary planning workshop held in July 2018. Implemented web access to indicator data through the [National IEA webpage and ERDDAP](https://www.integratedecosystemassessment.noaa.gov/regions/northeast/Indicator-data); [public github repo for 2019 report](https://github.com/NOAA-EDAB/soe), including intermediate data processing [documentation](https://noaa-edab.github.io/soe/) for improved transparency and reproducibility; retrospective documentation of past indicators, development of new indicators. 

Efficiencies gained through improved reporting infrastructure are allowing more scientific analysis of indicators as well. Priority given to indicator selection and evaluation, threshold analysis, synthetic methods such as DFA. Keep indicator data available and accessible for synthesis (ongoing), modeling, future work.

More stock specific reports in development to go to assessment working groups, see the protype Ecosystem Context for Stock Assessment report [ECSA](https://noaa-edab.github.io/ECSA/). This product is more interactive and intended for a scientific audience (e.g. with error bars on figures, links to methods, and data download capability), but many of the same data and analyses are used in the SOE.
Continued work with Councils and other management bodies on tailored integrated ecosystem reporting

# Conclusion
Flexibility and responsiveness to audience important, willing to change reporting as manager needs change. Retain elements of DPSIR and ecosystem services approaches [refs] while adjusting to regional needs.
