...
* data in standardized format with standardized plotting* publish technical methods separately for those that are interested (see [supplement](https://noaa-edab.github.io/tech-memo/); Technical methods as individual rmarkdown documents rolled up into one bookdown [@R-bookdown].)
* produce in Rmarkdown [@R-rmarkdown] for reproducibility and ease of conversion to different reports
