...
library(multipanelfigure); library(rerddap)
...
Final State of the Ecosystem reports were presented to the full Councils at their April meetings in 2018. Councils received their reports as both an in person presentation along with a pdf report in advance of the meeting. The main message of each presentation is whether there are big changes in the ecosystem or other threats to achieving Council management objectives. The presentation also provides an opportunity for Council discussion of further information that may be provided to enhance decision-making. 
...
df <- tabledap('species_groupings_V2', url = comet,
               ...
               #'SOE_18!="Other"', distinct = TRUE) #pull data 
