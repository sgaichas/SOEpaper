...
figureX <- fill_panel(figureX, file.path(image.dir,'GOM_GB zooplankton-1.pdf'), scaling = "fit", row = 2, column = 1)

figureX <- fill_panel(figureX, file.path(image.dir,'GOM_GB zooplankton-2.pdf'), scaling = "fit", row = 2, column = 2)

figureX <- fill_panel(figureX, file.path(image.dir,'NEFMC_Fish_Condition_2018.jpg'), scaling = "stretch", row = 3:4, column = 1)

figureX <- fill_panel(figureX, file.path(image.dir,'GOM_groundfish_productivity-1.pdf'), scaling = "stretch", row = 3:4, column = 2)
