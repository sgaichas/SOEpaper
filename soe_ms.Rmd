...
# Methods
Priorites included clear communication of relevance to management

* address OBJECTIVES, clearly align indicators with objectives (IEA process, @levin_integrated_2009, @levin_guidance_2014, WGNARS, @depiper_operationalizing_2017)
* conceptual model links environmental drivers, ecosystem components, human activities, and objectives @heemskerk_conceptual_2003, @zador_linking_2017, @depiper_operationalizing_2017
* put most manager-relevant things first: HUMAN DIMENSIONS instead of salinity, etc "one of the greatest perceived needs for decision-maker and stakeholder adoption of EBFM in the MAFMC and NEFMC is more information about human dimensions, including economics, jobs, revenue, and communities [@biedron_toward_2016]"

Ensure synthesis across indicators
...
Efficiency of production, delivery, and use by Councils
...
# Acknowledgments
We gratefully acknowledge Dr. John Boreman, chair of the MAFMC Scientific and Statistical Committee, for bluntly pointing out that initial draft ecosystem reporting lacked clear connections to management issues (and by extension, suggesting the title to this paper). *to add- indicator data contributors: Donald Anderson, Amani Bassyouni, Lisa Calvo, Heather Haas, Mike Hammil, Loren Kellogg, Kristin Kleisner, Dave Kulis, Kimberly Murray, Karl Roscher, Mark Terceiro*
