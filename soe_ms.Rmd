...
# Acknowledgments
We gratefully acknowledge Dr. John Boreman, chair of the MAFMC Scientific and Statistical Committee, for bluntly pointing out that initial draft ecosystem reporting lacked clear connections to management issues (and by extension, suggesting the title to this paper). Richard Seagraves, Mid-Atlantic Council staff (retired), contributed valuable insights on potential management uses of the SOE at the August 2017 workshop. We are grateful to Steve Traynor for developing the conceptual model graphics used in 2018, to Andrew Beet (Integrated Statistics and NEFSC) for editing the online technical methods, and to Mike Hammil (Department of Fisheries and Oceans, Canada) for background information on gray seals. Development of ecosystem reporting in the Northeast US has been greatly facilitated and improved through the International Council for the Exploration of the Sea's Working Group on the Northwest Atlantic Regional Sea (ICES WGNARS). 
