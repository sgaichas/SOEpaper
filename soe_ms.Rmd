...
address:
  ...
  - code: VDH
    address: Virginia Department of Health, Richmond, VA, USA
  - code: RU
...
Ecological synthesis is an important and notoriously difficult scientific endeavor [@ford_method_2001; @davanzo_symposium_2008]. While we strive for synthesis in the SOE reports, there is much further work to be done. However, because the SOE reports on scientific progress to date in many fields, connections drawn here can result in collaborative research going forward to improve our understanding. For example, the ecosystem productivity indicators shown above that elicited much discussion from the MAFMC led to a research project in progress linking zooplankton productivity to fish condition [ref? Laurel? or fill in alternates]. Management interest in these research questions is stimulated by their presentation in the SOE reports, and can help prioritize distribution of temporary resources.
...
After the 2018 Council reporting cycle, further improvements were made to allow access to the indicator data in the 2018 report. Web access to indicator data was implemented through the [National IEA webpage and ERDDAP](https://www.integratedecosystemassessment.noaa.gov/regions/northeast/Indicator-data) as part of a national initiative. Standard metadata for indicators are also included in the ERDDAP dataset [@simons_erddap_2017]. The goal is to keep indicator data available and accessible for synthesis (ongoing), but also have this information widely available for modeling or other analyses.
...
Efficiencies gained through improved reporting infrastructure are allowing more time scientific analysis of indicators as well. Over the coming reporting cycles, priority will be given to indicator selection and evaluation, threshold analysis, and synthetic multivariate methods such as DFA [@large_defining_2013; @tam_towards_2017; @otto_quantitative_2017; @samhouri_defining_2017]. 
