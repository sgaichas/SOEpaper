...
address:
  ...
  - code: NEFSCNJ
    address: NOAA NMFS Northeast Fisheries Science Center, Princeton, NJ, USA
  - code: WHOI
    address: Woods Hole Oceanographic Institution, Woods Hole, MA, USA
  - code: VDH
    address: Virginia Department of Health, 1Richmond, VA, USA
  - code: RU
    address: Rutgers University Haskin Shellfish Research Laboratory, Port Norris, NJ, USA
  - code: EDF
    address: Environmental Defense Fund, Boston, MA, USA
  - code: MDDNR
    address: Maryland Department of Natural Resources, Annapolis, MD, USA
