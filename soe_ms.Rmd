...
figureX <- fill_panel(figureX, file.path(image.dir,'NE zooplankton-1.pdf'), scaling = "fit",  row = 1, column = 1)

figureX <- fill_panel(figureX, file.path(image.dir,'NE zooplankton-2.pdf'), scaling = "fit", row = 2, column = 1)

figureX <- fill_panel(figureX, file.path(image.dir,'GOM_GB zooplankton-1.pdf'), scaling = "fit", row = 1, column = 2)
...
figureX <- fill_panel(figureX, file.path(image.dir,'groundfish productivity-1.pdf'), scaling = "stretch", row = 3:4, column = 2)
