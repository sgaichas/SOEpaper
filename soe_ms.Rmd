...
For example, there is clear interest in integrating ecosystem considerations within fishery management in the Northeast US [@biedron_toward_2016], and recent adoption of an ecosystem policy statement by one of the two Councils [@seagraves_mid-atlantic_2016]. Despite this interest, when presented with a draft "State of the Ecosystem" report formatted like one from the US West Coast [@noauthor_annual_nodate], managers and scientific reviewers alike asked "So what?" Fishery managers are faced with many issues, with overfull meeting agendas and briefing books containing hundreds of pages of material. While potentially interesting, managers needed to understand why ecosystem status and trends are relavant, given all of the other pressing issues they face. It is therefore important tha providers of ecosystem information to clearly link ecosystem indicators to management objectives [@degnbol_review_2004].

Our objective was to develop streamlined, relevant ecosystem reporting tailored to a particular audience: fishery managers. Efficiency is key, because reports go to two regional management bodies annually (and a third organization desires annual reporting as well). In this paper, we outline our process and key components of our revised reporting that efficiently deliver relevant ecosystem information to regional Councils; our lessons learned can readily apply to other regional ecosystem reporting efforts.
...
## Priority: Summarize report purpose, structure, and synthetic results in 2-3 pages

### Purpose: SOE Report Introduction
...
### Structure with management objectives: SOE Report Executive Summary
...
The main body of the report follows the executive summary with more detail on the indicator results. The full set of report sections and includes indicators of fishery performance, human community vulnerability, fishery interactions with protected species, resource species trends, and ecosystem conditions and productivity (Table \@ref(tab:SOEcontents)). Time series plots throughout the report use the standardized approach described in the executive summary to allow quick visual identification of significant trends, and observations within the most recent 10 years. 
