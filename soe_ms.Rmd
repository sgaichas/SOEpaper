...
* build on existing efforts inside and outside the region; ESRs @program_ecosystem_2012, @nefsc_northeast_2015; SOE west coast @noauthor_annual_nodate; Alaska @zador_ecosystem_2016
* keep it short, <25 printed pages
* keep language non-technical, don't include references etc in report
* response to SSC and previous Council comments section
* data in standardized format with standardized plotting
* publish technical methods separately for those that are interested (see [supplement](https://noaa-edab.github.io/tech-memo/); Technical methods as individual rmarkdown documents rolled up into one bookdown [@R-bookdown].)
* produce report in Rmarkdown [@R-rmarkdown] for reproducibility and ease of conversion to different reports
* version control on github (initial repo private)

Councils receive reports in April of each year (in person presentation along with pdf report), main message is whether there are big changes in the ecosystem or other threats to achieving their objectives
