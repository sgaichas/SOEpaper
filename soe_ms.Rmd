...
## Priority: Put human dimensions objectives first
...
# Discussion
Rising to the "so what" challenge improved ecosystem reporting in the NE US and has resulted in other analyses of use to managers. Put best practices/lessons learned from IEA group WGNARS [@levin_integrated_2009, @levin_guidance_2014, @depiper_operationalizing_2017] into actual practice. 

Management gains
An effective annual process has evolved where contextual information is presented that can change multiple decisions if necessary (@zador_ecosystem_2016, value of qualitative information). What should managers do with this information? In the absence of management decision criteria based on indicator thresholds (work is ongoing [refs]), information from these reports has been used in management. 
The MAFMC is integrating State of the Ecosystem report indicators within its Ecosystem Approach to Management, specifically within an indicator-based risk assesssment []. MAFMC wants to see the SOE report and indicators inform their risk assessment as part of EAFM, want to add management oriented indicators such as other ocean uses and regulatory complexity. In June 2018, NEFMC requested a prototype ecosystem-level risk assessment as well, and production was simple: indicators for the Gulf of Maine and Georges Bank replaced those for the Mid-Atlantic Bight. This quick analysis gave New England managers a provisional example to determine whether a more in-depth analysis would be useful for them.  

Science contributions
Synthesis an important scientific contribution (example refs). Components used here for reporting are also immediately useful in scientific context, such as conceptual model transition to qualitative network modeling to evaluate simple system perturbations in an integrated social-ecological system [@zador_linking_2017]. 

Technical methods an important scientific contribution. Evolution of inidicator analysis to address time series autocorrelation in PCA []. Here done for trend analysis in general, finding that widely applied methods may give unreliable statistical significance for shorter indicator time series [ref in review simulation paper]. 
...
Next steps (in progress for the 2019 report): web access to indicator data through the [National IEA webpage and ERDDAP](https://www.integratedecosystemassessment.noaa.gov/regions/northeast/Indicator-data); [public github repo for 2019 report](https://github.com/NOAA-EDAB/soe), including intermediate data processing [documentation](https://noaa-edab.github.io/soe/) for improved transparency and reproducibility; retrospective documentation of past indicators, development of new indicators. Priority given to indicator selection and evaluation, threshold analysis, synthetic methods such as DFA. Keep indicator data available and accessible for synthesis (ongoing), modeling, future work.

More stock specific reports in development to go to assessment working groups, see [ECSA](https://noaa-edab.github.io/ECSA/)
...
# Acknowledgments
We gratefully acknowledge Dr. John Boreman, chair of the MAFMC Scientific and Statistical Committee, for bluntly pointing out that initial draft ecosystem reporting lacked clear connections to management issues (and by extension, suggesting the title to this paper). Development of ecosystem reporting in the Northeast US has been greatly facilitated and improved through the International Council for the Exploration of the Sea's Working Group on the Northwest Atlantic Regional Sea (ICES WGNARS). *to add- indicator data contributors: Donald Anderson, Amani Bassyouni, Lisa Calvo, Heather Haas, Mike Hammil, Loren Kellogg, Kristin Kleisner, Dave Kulis, Kimberly Murray, Karl Roscher, Mark Terceiro*
