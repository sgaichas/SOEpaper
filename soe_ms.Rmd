...
**Fig \@ref(fig:MABecoprod). Mid-Atlantic ecosystem productivity indicators.** Small-large copepod index with primary productivity anomaly (A), *C. typicus* abundance anomaly (B), groundfish condition (C), and groundfish productivity for MAFMC managed species in the Mid-Atlantic (D).
