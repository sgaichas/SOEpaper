...
author:
  - name: Sarah K. Gaichas
    affiliation: '1'
    etal: Gaichas # First author's last name. 
    email: Sarah.Gaichas@noaa.gov # Indicates corresponding Author
    institution: Woods Hole Laboratory, NOAA NMFS Northeast Fisheries Science Center
...
affiliation:
  - id: '1'
    department: Woods Hole Laboratory
    institution: NOAA NMFS Northeast Fisheries Science Center
    city: Woods Hole
    state: MA # only USA, Australia, Canada
    country: USA
  - id: '2' 
    institution: Integrated Statistics
    city: Woods Hole
    state: MA # only USA, Australia, Canada
    country: USA
  - id: '3' 
    department: Social Sciences Branch c/o Headquarters
    institution: NOAA NMFS Northeast Fisheries Science Center
    city: Silver Spring
    state: MD # only USA, Australia, Canada
    country: USA
  - id: '4' 
    department: Narragansett Laboratory
    institution: NOAA NMFS Northeast Fisheries Science Center
    city: Narragansett
    state: RI # only USA, Australia, Canada
    country: USA
  - id: '5' 
    department: Geophysical Fluid Dynamics Laboratory, Princeton University
    institution: NOAA NMFS Northeast Fisheries Science Center
    city: Princeton
    state: NJ # only USA, Australia, Canada
    country: USA
  - id: '6' 
    department: Biology
...
\tiny
 \keyFont{ \section{Keywords:} ecosystem approach, natural resource management, fisheries, integrated ecosystem assessment, ecosystem indicators, economic indicators, management objectives } 
