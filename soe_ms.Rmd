...
Why, then, is it still relatively rare to see information on ecosystem status and trends routinely considered in fishery management? Direct consideration of ecosystem factors has been limited in fishery management historically at the population level [@skern-mauritzen_ecosystem_2016]. However, perceived difficulties with implementation of ecosystem based management are are being resolved [@patrick_myths_2015], and indirect consideration of ecosystem factors at the population level is increasing [@marshall_inclusion_2018]. There are several routes for ecosystem information to enter the management system: directly within analyses aimed at providing population or stock-level harvest advice (stock assessments), and within analyses aimed at providing habitat, multispecies, or ecosystem-level advice []. Multiple levels are necessary: considering only stock level advice leads to potentially counterproductive management if stock interactions are not considered, while considering only system level advice misses how stocks may respond differently to common environmental signals. Many fishery management systems are set up to consider stock level advice, but have few clear processes to consider system level advice []. 
...
Our objective was to develop streamlined, relevant ecosystem reporting tailored to a particular audience: fishery managers. 
...
# Acknowledgments
*to add- indicator data contributors: Donald Anderson, Amani Bassyouni, Lisa Calvo, Heather Haas, Mike Hammil, Loren Kellogg, Kristin Kleisner, Dave Kulis, Kimberly Murray, Karl Roscher, Mark Terceiro*
