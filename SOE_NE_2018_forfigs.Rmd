...
soe.plot(SOE.data.2018, "Time","Apex Predator Landings GOM", stacked = "Apex predators",status = F,
         endshade = T, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3,end.start = 2007, x.start = 1964,
         ymin = FALSE, y.lower = 0, cex.stacked = 2)

soe.plot(SOE.data.2018, "Time", "Piscivore Landings GOM", stacked = "Piscivores",status = F,
         endshade = T, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3,end.start = 2007, x.start = 1964,
         ymin = FALSE, y.lower = 0 , extra = TRUE, x.var2 = "Time", 
         y.var2 = "Piscivore NEFMC managed species sea food GOM", mean_line = T, cex.stacked = 2)


soe.plot(SOE.data.2018, "Time", "Planktivore Landings GOM", stacked = "Planktivores",status = F,
         endshade = T, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3,end.start = 2007, x.start = 1964,
         ymin = FALSE, y.lower = 0 , extra = TRUE, x.var2 = "Time", 
         y.var2 ="Planktivore NEFMC managed species sea food GOM", mean_line = T, cex.stacked = 2)
soe.plot(SOE.data.2018, "Time", "Benthivore Landings GOM", stacked = "Benthivores",status = F,
         endshade = T, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3,end.start = 2007, x.start = 1964,
         ymin = FALSE, y.lower = 0 , extra = TRUE, x.var2 = "Time", 
         y.var2 = "Benthivore NEFMC managed species sea food GOM", mean_line = T, cex.stacked = 2)
soe.plot(SOE.data.2018, "Time", "Benthos Landings GOM", stacked = "Benthos",status = F,
         endshade = T, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3,end.start = 2007, x.start = 1964,
         ymin = FALSE, y.lower = 0 , extra = TRUE, x.var2 = "Time", 
...
soe.plot(SOE.data.2018, "Time","Apex Predator Landings GB", stacked = "Apex predators",status = F,
         endshade = T, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3,end.start = 2007, x.start = 1964,
         ymin = FALSE, y.lower = 0, cex.stacked = 2)

soe.plot(SOE.data.2018, "Time", "Piscivore Landings GB", stacked = "Piscivores",status = F,
         endshade = T, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3,end.start = 2007, x.start = 1964,
         ymin = FALSE, y.lower = 0 , extra = TRUE, x.var2 = "Time", 
         y.var2 = "Piscivore NEFMC managed species sea food GB", mean_line = T, cex.stacked = 2)


soe.plot(SOE.data.2018, "Time", "Planktivore Landings GB", stacked = "Planktivores",status = F,
         endshade = T, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3,end.start = 2007, x.start = 1964,
         ymin = FALSE, y.lower = 0 , extra = TRUE, x.var2 = "Time", 
         y.var2 ="Planktivore NEFMC managed species sea food GB", mean_line = T, cex.stacked = 2)
soe.plot(SOE.data.2018, "Time", "Benthivore Landings GB", stacked = "Benthivores",status = F,
         endshade = T, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3,end.start = 2007, x.start = 1964,
         ymin = FALSE, y.lower = 0 , extra = TRUE, x.var2 = "Time", 
         y.var2 = "Benthivore NEFMC managed species sea food GB", mean_line = T, cex.stacked = 2)
soe.plot(SOE.data.2018, "Time", "Benthos Landings GB", stacked = "Benthos",status = F,
         endshade = T, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3,end.start = 2007, x.start = 1964,
         ymin = FALSE, y.lower = 0 , extra = TRUE, x.var2 = "Time", 
...
soe.plot(SOE.data.2018, "Time", "Total Landings GOM", stacked = "GOM",status = F,
         endshade = T, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3,end.start = 2007, x.start = 1964,
         ymin = FALSE, y.lower = 0 , extra = TRUE, x.var2 = "Time", 
         y.var2 =  "Total managed landings GOM")
soe.plot(SOE.data.2018, "Time", "Total Landings GB", stacked = "GB",status = F,
         endshade = T, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3,end.start = 2007, x.start = 1964,
         ymin = FALSE, y.lower = 0 , extra = TRUE, x.var2 = "Time", 
...
```{r, NE_zooplankton, fig.cap="Small-large copepod index with primary productivity anomaly in Gulf of Maine (A) and Georges Bank (B).\\label{ppcope}",echo = F, warning = F, include = T,  fig.show='hold', fig.align='default', warning = F, message = F, out.width='.49\\linewidth'}
...
soe.plot(SOE.data.2018, "Time", "Pseudocalanus spp. abundance anomaly GOM", stacked = "GOM Pseudo.",
         rel.y.num = 1.1,line.forward = T, cex.stacked = 1.5,end.start = 2006,
         anomaly = T)
soe.plot(SOE.data.2018, "Time", "Calanus finmarchicus abundance anomaly GOM", stacked = "GOM Cal. fin.",
         rel.y.num = 1.1, line.forward = T,cex.stacked = 1.5,end.start = 2006,
         anomaly = T)
...
soe.plot(SOE.data.2018, "Time", "Pseudocalanus spp. abundance anomaly GB", stacked = "GB Pseudo",
         rel.y.num = 1.1,line.forward = T, cex.stacked = 1.5,end.start = 2006,
         anomaly = T, suppressAxis = T)
soe.plot(SOE.data.2018, "Time", "Calanus finmarchicus abundance anomaly GB", stacked = "GB Cal. fin.",
         rel.y.num = 1.1, line.forward = T,cex.stacked = 1.5,end.start = 2006,
         anomaly = T)
soe.stacked.axis("Year", "Abundance anomaly")
...
```{r GOM_groundfish_productivity, fig.cap="Groundfish productivity (A: NEFMC managed species, B: Commercial Species in New England)", echo = F, out.width='9.2cm', out.height='9.2cm', fig.show='hold', fig.align = 'center',fig.pos='H'}
